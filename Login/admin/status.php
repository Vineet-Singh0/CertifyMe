        ...
        <form action="status.php?Id=<?php echo $Id; ?>" class="form-horizontal row" method="POST" enctype="multipart/form-data">
          ...
          <div class="panel panel-info">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-7">
                    <!-- Set the value attribute with the applicant's name from the result -->
     ...
     if($data)
      {
        ...
        ?>
        <meta http-equiv="refresh" content="0; URL=http://localhost/MiniProject/Login/admin/form_details.php" />
        <?php
