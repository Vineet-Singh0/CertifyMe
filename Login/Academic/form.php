...
.status-btn {
   background-color: #6FA4D8; /* Light Blue */
}

.status-btn:hover {
   background-color: #5083B3; /* Darker Blue on hover */
}

.status-btn:active {
   background-color: #406A8A; /* Even Darker Blue on click */
}
.updates 
      {
         padding: 8px 15px;
...
<header class="header">
   ...
   <section class="flex">
      ...
      <div class="profile">
         ...
         <h3 class="name"><?php echo $_SESSION['acad_name'] ?></h3>
...
<section class="about">
   ...
   <div class="row">
      ...
      $sql = "SELECT `Id`, `Required_Document`, `Applicant_Name`, `PRN`, `Mobile`, `Email`, `Subject`, `Fees_Paid`, `Delivery_Method`, `Number_of_Copies` FROM `form` WHERE `Required_Document` = 'bonafide'";
