   ...
   if(isset($_POST['submit'])){
    ...
    $Number_copies = $_POST['noc']; 
      ...
      // Die if connection was not successful
        ...
        $sql = "INSERT INTO form (`Required_Document`, `Applicant_Name`, `PRN`, `Mobile`, `Gender`, `Email`, `Address`, `Current_Year`, `Result`, `Subject`, `Passing_Year`, `Fees_Paid`, `Delivery_Method`, `Number_of_Copies`) VALUES ('$required', '$name', '$prn', '$mobile', '$gender', '$email', '$address', '$year', '$result', '$subject', '$passing_year', '$fees', '$delivery', '$Number_copies')";
...
.profile h3 {
    ...
    margin: 3px; /* Add this to remove margin */
}
...
<div class="container-fluid">
      <div class="row">
        ...
        <form action="application_form.php" class="form-horizontal row" method="POST" enctype="multipart/form-data">
